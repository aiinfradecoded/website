...
export const metadata = {
  title: "AgentForge — production-grade AI infrastructure boilerplate",
  description:
    "Source-available AI infrastructure for senior engineers. Tier-routed LLM, multi-turn streaming, hybrid pgvector RAG, eval harness with CI gate, observability, billing — wired and tested. FastAPI + Next.js 15. Bring your own keys or run keyless on Ollama / vLLM.",
