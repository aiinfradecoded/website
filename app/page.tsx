            ...
            <div className="rounded-2xl border border-zinc-800/60 bg-gradient-to-br from-zinc-900/60 to-zinc-950 p-7">
              ...
              <div className="mt-5 space-y-5">
                {[
                  ...
                  { value: "303", label: "tests", note: "unit + stress + concurrency" },
                ].map((s) => (
 ...
 * and doesn't add image weight to the page.
 *
  ...
  return (
    <div className="min-w-0">
      <div className="rounded-xl border border-zinc-800/70 bg-zinc-950 shadow-2xl shadow-cyan-500/[0.06] overflow-hidden">
        ...
        {/* Top bar — matches the real dashboard's header */}
        ...
        <div className="border-t border-zinc-800/70 bg-zinc-900/40 px-4 py-2 text-[10px] text-zinc-500">
          The actual dashboard at <span className="font-mono text-cyan-400">127.0.0.1:7820</span> — eight tabs, sixty-four tools, live tool calls.
        </div>
      </div>
    </div>
  );
